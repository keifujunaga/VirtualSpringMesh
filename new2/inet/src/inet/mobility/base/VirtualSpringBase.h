...
#ifndef __INET_VIRTUALSPRINGBASE_H
#define __INET_VIRTUALSPRINGBASE_H
 ...
 * @author Andras Varga
 */
class INET_API VirtualSpringBase : public MovingMobilityBase
{
  protected:
...
#endif // ifndef __INET_VirtualSpringBase_H
